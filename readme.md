...
1.  Get a copy of this repository, either by cloning it with git, downloading the latest [release](https://github.com/jowr/librefprop.so/archive/v0.5.zip) or the current [development version](https://github.com/jowr/librefprop.so/archive/master.zip).
