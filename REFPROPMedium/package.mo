...
constant String explicitVars = "ph"
  "set of Variables the model is explicit for maybe set to all combinations of p,h,T,d,s,d, REFPROP works internally with dT";
...
constant String REFPROP_PATH = "d:\\Program Files (x86)\\REFPROP\\"
  "this is placed here because the double backslashes can confuse the parser";
...
<ul>
  ...
  So you need to set the path to the REFPROP program directory with the constant String REFPROP_PATH at the end of this package. 
